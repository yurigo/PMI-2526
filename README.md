...
└── sessions/
    ...
    └── session19/              # JavaScript: Contenido del DOM y Temporizadores
        ├── README.md
        └── example/
            ├── session19/      # Ejemplo de innerHTML, createElement, appendChild y setTimeout
            └── temporizador/   # Temporizador de cuenta atrás con querySelector e parseInt
    └── session20/              # JavaScript: El objeto Date y Librerías de Terceros
        ├── README.md
        ├── cuentaAtras/        # Cuenta atrás hasta una fecha con Date y setTimeout recursivo
