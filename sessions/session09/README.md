...
El enunciado completo de la actividad está disponible en:

- [`flex-activity.md`](./flex-activity.md) — descripción textual de la actividad
- [`flex-activity.png`](./flex-activity.png) — captura visual de referencia

El código de ejemplo desarrollado en clase se encuentra en la carpeta [`mwc/`](./mwc/).
